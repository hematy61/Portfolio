  ...
  <section id="about-me" className={about_me_container} >
    <div className={content_frame} >
      <p>
        ...
        Finally he found web development is what he needs. 
        He never forget the first <code><span>console</span><span>.log(</span>"Hello World!!!!"<span>)</span></code> and the excitement that took over him.
